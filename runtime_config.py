...
_HYDRO_NUMERIC_LIMITS = {
    ...
    "HYDRO_CELL_FRAME_MAX_AGE_MIN": (5, 180),
    "HYDRO_ROUTING_TAIL_MIN": (0, 360),
    "HYDRO_PRECIP_LEDGER_RETENTION_MIN": (0, 720),
    "HYDRO_LEDGER_MAX_GAP_MIN": (1, 180),
    "HYDRO_PENDING_RETENTION_HOURS": (1, 720),
    "HYDRO_FAILED_SAMPLE_RETENTION_DAYS": (1, 3650),
    "HYDRO_DATASET_RETENTION_DAYS": (1, 3650),
    "HYDRO_EVENT_GAP_MIN": (10, 1440),
    "HYDRO_ML_MIN_TRAIN_EVENTS": (1, None),
    "HYDRO_ML_MIN_VALIDATION_EVENTS": (1, None),
    "HYDRO_ML_MATERIALIZE_BATCH_SIZE": (1, 10000),
    "HYDRO_Q_HISTORY_RETENTION_DAYS": (1, 3650),
    "HYDRO_ML_SAMPLE_INTERVAL_MIN": (1, 1440),
    "HYDRO_ML_MAX_SAMPLES_PER_STATION_EVENT": (1, 100000),
    "HYDRO_ML_MAX_NO_CELL_SAMPLES_PER_DAY": (1, 10000),
    "HYDRO_ML_MAX_TRAINING_SAMPLES": (100, 1000000),
}
