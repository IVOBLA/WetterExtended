...
const PARAM_GROUPS = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: 'SLOW_CELL_MAX_KMH',           type: 'number', default: 15,   unit: 'km/h',  desc: 'Unter diesem Wert gilt eine Zelle als "langsam ziehend" (eigener Bedrohungstyp, normaler Warnradius).', example: 15 },
  ...
  },
  {
    ...
    params: [
      ...
      { key: 'HYDRO_PRECIP_LEDGER_ENABLED', type: 'boolean', default: true, desc: 'Beruecksichtigt bereits durchgezogenen Zellniederschlag im Einzugsgebiet.', example: true },
      { key: 'HYDRO_PRECIP_LEDGER_RETENTION_MIN', type: 'number', default: 180, unit: 'min', desc: 'Wie lange gefallener Zellniederschlag nachwirkt. Leer = obere Grenze von HYDRO_LAG_WINDOW_MIN.', example: 180 },
      { key: 'HYDRO_LEDGER_MAX_GAP_MIN', type: 'number', default: 20, unit: 'min', desc: 'Groesste Frame-Luecke, ueber die Niederschlag integriert wird.', example: 20 },
