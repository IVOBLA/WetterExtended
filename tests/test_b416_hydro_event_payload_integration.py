...
def test_pending_payload_comes_from_feature_row_without_geometry(monkeypatch,tmp_path):
    ...
    monkeypatch.setattr(h,"_precip_from_cells",lambda station,cells:{"cell_diagnostics":diagnostics,"contributing_cell_count":2,"cell_catchment_count":2,"cell_precip_source_type":"cell_derived","cell_catchment_precip_sum_mm":1.0,"cell_catchment_precip_weighted_sum_mm":1.0,"cell_catchment_max_intensity":2.0,"precip_evaluable_by_geometry":True,"precip_status":"cell_derived","precip_status_label":"x","catchment_geometry_available":True,"catchment_geometry_status":"ok","catchment_area_geometry_km2":1.0})
