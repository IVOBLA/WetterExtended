...
def fetch_cloud_height_for_points(latlons: list) -> dict:
    ...
    Rückgabe: {(lat, lon): cloud_height_m oder None} — None wenn nicht ableitbar.
    """
    ...
    if not tif_files:
        debug_log("[CLOUD-GRID] Kein TIFF vorhanden — fetch_cloud_height_for_points gibt Missing zurück")
        return {ll: None for ll in latlons}
